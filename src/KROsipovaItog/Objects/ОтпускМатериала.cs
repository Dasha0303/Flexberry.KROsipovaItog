...
namespace IIS.KROsipovaItog
{
    ...
    public class ОтпускМатериала : ICSSoft.STORMNET.DataObject
    {
        ...
        private System.DateTime fДатаПроводки = System.DateTime.Now;
        
        private IIS.KROsipovaItog.Сотрудники fСотрудники;
        
        private IIS.KROsipovaItog.Заказ fЗаказ;
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        [NotNull()]
        public virtual IIS.KROsipovaItog.Заказ Заказ
        {
            get
            {
                ...
                IIS.KROsipovaItog.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтпускМатериалаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтпускМатериалаE", typeof(IIS.KROsipovaItog.ОтпускМатериала));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтпускМатериалаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтпускМатериалаL", typeof(IIS.KROsipovaItog.ОтпускМатериала));
                }
            }
        }
    }
