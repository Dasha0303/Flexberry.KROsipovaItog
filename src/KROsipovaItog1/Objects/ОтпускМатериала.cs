...
namespace IIS.KROsipovaItog1
{
    ...
    public class ОтпускМатериала : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KROsipovaItog1.Заказ fЗаказ;
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        [NotNull()]
        public virtual IIS.KROsipovaItog1.Заказ Заказ
        {
            get
            {
                ...
                IIS.KROsipovaItog1.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтпускМатериалаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтпускМатериалаE", typeof(IIS.KROsipovaItog1.ОтпускМатериала));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтпускМатериалаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтпускМатериалаL", typeof(IIS.KROsipovaItog1.ОтпускМатериала));
                }
            }
        }
    }
