...
moduleForModel('i-i-s-k-r-osipova-itog1-т-ч-акта-приемки', 'Unit | Serializer | i-i-s-k-r-osipova-itog1-т-ч-акта-приемки', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-k-r-osipova-itog1-т-ч-акта-приемки',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
